...
# from sklearn.externals import joblib (depreciated and removed since 0.23) 
import joblib
...
MODEL_FILE_NAME = 'irisSVM.pkl'
MODEL_LOCAL_PATH = MODEL_FILE_NAME # Originally stored in '/tmp/' folder
